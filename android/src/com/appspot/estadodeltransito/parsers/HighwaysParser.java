...
public class HighwaysParser {
    private static final Pattern groupPattern = Pattern.compile("accesos\\s*a\\s*capital\\s*federal\\s*</div>(.*?)avenidas de", Pattern.DOTALL | Pattern.CASE_INSENSITIVE);
