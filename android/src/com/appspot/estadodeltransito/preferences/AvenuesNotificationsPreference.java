...
public class AvenuesNotificationsPreference extends DialogPreference {
    ...
    public AvenuesNotificationsPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    protected View onCreateDialogView() {
        ...
        for (String avenue : mContext.getResources().getStringArray(R.array.avenues_list) ) {
            CheckBox bt = new CheckBox(mContext);
            bt.setText(avenue);

            if ( mValueParser.contains(avenue) ) {
            	bt.setChecked(true);
            }
