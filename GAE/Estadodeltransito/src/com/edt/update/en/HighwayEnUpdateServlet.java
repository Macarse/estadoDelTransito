...
public class HighwayEnUpdateServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		String dataQuery = "select from " + Access.class.getName() + " where type=='Highway'";
		String deleteQuery = "select from " + AccessEn.class.getName() + " where type=='Highway'";
		...
		for (Access access : accessList) {
			try {
				...
				if(access.getStatusMessageFrom() != null) {
					...
					newAccess.setStatusMessageFrom(Translate.execute(access.getStatusMessageFrom(), Language.SPANISH, Language.ENGLISH).replaceAll("Slaughter","Mataderos"));
				...
				if(access.getStatusMessageTo() != null) {
					...
					newAccess.setStatusMessageTo(Translate.execute(access.getStatusMessageTo(), Language.SPANISH, Language.ENGLISH).replaceAll("Slaughter","Mataderos"));
